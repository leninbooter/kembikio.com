<h1 class="titulo">Planes de Servicio</h1>
<ul id="inf_planes">
	<li>
		<h2>Consultas Gratuitas</h2>
		<p class="precio">¡Gratis!<br/><span>&nbsp;</span></p>
		<p class="condiciones">&nbsp;</p>
		<p class="solicitar"><a class="boton" href="">Solicitar</a></p>
		<ul>
			<li>Consulta de 30 minutos</li>
			<li>Consulta en remoto</li>
			<li>PC, MAC y perifericos</li>
		</ul>
	</li>
	<li>
		...
		<ul>
			...
			<li>Configuracion y conectividad</li>
		</ul>
	</li>
	<li>
	...
	<li>
		...
		<ul>
			...
			<li>Configuracion y conectividad</li>
			<li>Soporte remoto y en sitio</li>
			<li>Eliminación de spyware y adware</li>
		</ul>
	</li>	
</ul>
